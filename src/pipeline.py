...
PIPELINE_STEPS = [
    ...
    PipelineStep("causal_inference", "causal_inference", "estimate adjusted treatment effects and separate correlation from causation"),
    PipelineStep("build_panel_data", "build_panel_data", "build dashboard-ready panel data"),
    PipelineStep("user_behavior_model", "user_behavior_model", "model Exposure -> Attention -> Engagement -> Conversion -> ROI funnel"),
    PipelineStep("temporal_dynamics", "temporal_dynamics", "analyze stage-aware ROI dynamics"),
    PipelineStep("graph_analysis", "graph_analysis", "build team-player-sponsor-match network metrics"),
    PipelineStep("graph_learning", "graph_learning", "run graph learning proxies and link prediction"),
    PipelineStep("ab_simulation", "ab_simulation", "run counterfactual A/B sponsor scenarios"),
    PipelineStep("counterfactual_engine", "counterfactual_engine", "run SCM-style sponsor ROI interventions"),
    PipelineStep("scenario_engine", "scenario_engine", "rank sponsor strategy scenarios"),
    PipelineStep("sponsor_optimization", "sponsor_optimization", "optimize budget-constrained sponsor allocation"),
    PipelineStep("decision_system", "decision_system", "generate sponsor investment recommendations and risk warnings"),
    PipelineStep("generative_report", "generative_report", "write commercial insight brief"),
    PipelineStep("generative_insight_engine", "generative_insight_engine", "write causal sports intelligence executive report"),
