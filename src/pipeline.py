...
PIPELINE_STEPS = [
    ...
    PipelineStep("sponsor_optimization_engine", "sponsor_optimization_engine", "optimize sponsor portfolios under budget constraints"),
    PipelineStep("causal_inference", "causal_inference", "estimate causal evidence for ROI drivers"),
    PipelineStep("temporal_modeling", "temporal_modeling", "model time-aware ROI dynamics"),
    PipelineStep("funnel_behavior_modeling", "funnel_behavior_modeling", "model fan funnel conversion and decay"),
    PipelineStep("graph_learning", "graph_learning", "predict future sponsor-team links"),
    PipelineStep("counterfactual_engine", "counterfactual_engine", "simulate counterfactual ROI shocks"),
    PipelineStep("tail_risk_analysis", "tail_risk_analysis", "rank worst-case and risk-sensitive ROI decisions"),
    PipelineStep("generative_insight_engine", "generative_insight_engine", "write causal and decision intelligence brief"),
