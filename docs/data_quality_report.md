...
| --- | --- | --- | --- | --- | --- | --- |
| data/media_text_corpus.csv | 5057 | 15 | 10262 | 0 | real historical/text source | medium-high |
| data/real_text_articles.csv | 5057 | 10 | 148 | 0 | real historical/text source | medium-high |
...
| data/text_embeddings_reduced.csv | 5057 | 31 | 0 | 0 | proxy/mock commercial data | medium-low |
...
| --- | --- | --- | --- | --- | --- |
| real historical/text source | medium-high | 4 | 60515 | 10554 | 0 |
| proxy/mock commercial data | medium-low | 18 | 34028 | 0 | 1922 |
...
| real_text_articles.csv | 5057 | 10 | 148 | 0 | text_id, source, title, url, domain, language, sourcecountry, published_at |
| text_embeddings_reduced.csv | 5057 | 31 | 0 | 0 | text_id, source, domain, narrative_topic, sentiment_score, text_svd_01, text_svd_02, text_svd_03 |
| attention_timeseries.csv | 10604 | 7 | 0 | 0 | match_id, day_offset, team_a, team_b, attention_index, engagement_rate, sentiment_score |
| media_text_corpus.csv | 5057 | 15 | 10262 | 0 | text_id, source, sample_headline, source_url, domain, language, sourcecountry, published_at |
