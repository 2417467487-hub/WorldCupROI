...
| data/attention_timeseries.csv | proxy/mock commercial data | medium-low | 10604 rows x 7 columns | 449.8000 | Replace with licensed sponsor CRM, sales, broadcast, or social platform data. |
...
| data/media_text_corpus.csv | real historical/text source | medium-high | 6249 rows x 15 columns | 3997.3000 | Refresh from source APIs and pin source snapshots with data versioning. |
| data/modeling_dataset.csv | proxy/mock commercial data | medium-low | 964 rows x 87 columns | 792.6000 | Replace with licensed sponsor CRM, sales, broadcast, or social platform data. |
...
| data/raw/gdelt_worldcup_articles_deduped.json | real historical/text source | medium-high |  | 156.0000 | Refresh from source APIs and pin source snapshots with data versioning. |
...
| data/real_text_articles.csv | real historical/text source | medium-high | 6249 rows x 10 columns | 3894.4000 | Refresh from source APIs and pin source snapshots with data versioning. |
...
| data/roi_predictions.csv | proxy/mock commercial data | medium-low | 964 rows x 89 columns | 800.9000 | Replace with licensed sponsor CRM, sales, broadcast, or social platform data. |
...
| data/team_player_sponsor_match_edges.csv | proxy/mock commercial data | medium-low | 6112 rows x 4 columns | 305.4000 | Replace with licensed sponsor CRM, sales, broadcast, or social platform data. |
...
| data/text_embeddings_reduced.csv | proxy/mock commercial data | medium-low | 6249 rows x 31 columns | 1775.5000 | Replace with licensed sponsor CRM, sales, broadcast, or social platform data. |
| data/user_behavior_chain.csv | proxy/mock commercial data | medium-low | 1928 rows x 42 columns | 526.8000 | Replace with licensed sponsor CRM, sales, broadcast, or social platform data. |
