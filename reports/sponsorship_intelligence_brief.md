...
- ROI model: - R2: 0.8595
- Key ROI drivers: a_sponsor_spend_m, a_brand_heat_index, team_a_strength, a_ad_exposure_m, sponsor_team_fit_score, commercial_momentum_score
