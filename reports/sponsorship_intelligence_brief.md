...
- ROI model: - R2: 0.8654
- Key ROI drivers: a_sponsor_spend_m, a_brand_heat_index, team_a_strength, a_ad_exposure_m, commercial_momentum_score, sponsor_team_fit_score
