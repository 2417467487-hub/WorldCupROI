...
- Match model: - Accuracy: 0.5023
- ROI model: - R2: 0.8478
- Key ROI drivers: team_a_strength, a_ad_exposure_m, a_sponsor_spend_m, a_brand_heat_index, fan_score, commercial_momentum_score
...
- Average prediction interval width: 0.436
- Average Monte Carlo std: 0.133
- Medium-risk cases: 118
- High-risk cases: 0
