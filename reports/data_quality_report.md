...
| --- | --- | --- | --- | --- | --- | --- |
| data/media_text_corpus.csv | 4321 | 15 | 8778 | 0 | real historical/text source | medium-high |
| data/raw/international_results.csv | 49437 | 9 | 144 | 0 | real historical/text source | medium-high |
| data/real_text_articles.csv | 4321 | 10 | 136 | 0 | real historical/text source | medium-high |
...
| data/text_embeddings_reduced.csv | 4321 | 31 | 0 | 0 | proxy/mock commercial data | medium-low |
...
| --- | --- | --- | --- | --- | --- |
| real historical/text source | medium-high | 4 | 59043 | 9058 | 0 |
| proxy/mock commercial data | medium-low | 18 | 33292 | 0 | 1922 |
...
| --- | --- | --- | --- | --- | --- | --- |
| data/media_text_corpus.csv | team_a | float64 | 0.0000 | 4321 | 0 | real historical/text source |
| data/media_text_corpus.csv | team_b | float64 | 0.0000 | 4321 | 0 | real historical/text source |
| data/media_text_corpus.csv | source_url | object | 0.9843 | 68 | 10 | real historical/text source |
| data/media_text_corpus.csv | published_at | object | 0.9843 | 68 | 387 | real historical/text source |
| data/real_text_articles.csv | url | object | 0.9843 | 68 | 10 | real historical/text source |
| data/real_text_articles.csv | published_at | object | 0.9843 | 68 | 387 | real historical/text source |
...
| data/media_text_corpus.csv | text_id | int64 | 1.0000 | 0 | 4321 | real historical/text source |
| data/media_text_corpus.csv | source | object | 1.0000 | 0 | 4 | real historical/text source |
| data/media_text_corpus.csv | sample_headline | object | 1.0000 | 0 | 3387 | real historical/text source |
| data/media_text_corpus.csv | domain | object | 1.0000 | 0 | 2 | real historical/text source |
| data/media_text_corpus.csv | language | object | 1.0000 | 0 | 1 | real historical/text source |
| data/media_text_corpus.csv | sourcecountry | object | 1.0000 | 0 | 1 | real historical/text source |
| data/media_text_corpus.csv | sentiment_score | float64 | 1.0000 | 0 | 171 | real historical/text source |
| data/media_text_corpus.csv | narrative_topic | object | 1.0000 | 0 | 4 | real historical/text source |
| data/media_text_corpus.csv | match_id | int64 | 1.0000 | 0 | 964 | real historical/text source |
| data/media_text_corpus.csv | news_sentiment_score | float64 | 1.0000 | 0 | 171 | real historical/text source |
...
| real historical/text source | 51 | 0.9595 | 9058 |
...
| data/text_embeddings_reduced.csv | text_svd_02 | 0 | 1.0000 | 720 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_y | 0 | 1.0000 | 720 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_03 | 0 | 1.0000 | 704 | Review before production modeling |
...
| data/text_embeddings_reduced.csv | text_svd_05 | 0 | 1.0000 | 388 | Review before production modeling |
| data/modeling_dataset.csv | b_ad_exposure_m | 0 | 1.0000 | 227 | Review before production modeling |
| data/roi_predictions.csv | b_ad_exposure_m | 0 | 1.0000 | 227 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_04 | 0 | 1.0000 | 171 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_13 | 0 | 1.0000 | 154 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_06 | 0 | 1.0000 | 153 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_11 | 0 | 1.0000 | 153 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_15 | 0 | 1.0000 | 153 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_21 | 0 | 1.0000 | 145 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_10 | 0 | 1.0000 | 137 | Review before production modeling |
| data/user_behavior_chain.csv | funnel_efficiency | 0 | 1.0000 | 129 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_20 | 0 | 1.0000 | 128 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_17 | 0 | 1.0000 | 117 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_12 | 0 | 1.0000 | 107 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_08 | 0 | 1.0000 | 100 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_09 | 0 | 1.0000 | 92 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_19 | 0 | 1.0000 | 88 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_24 | 0 | 1.0000 | 87 | Review before production modeling |
| data/panel_dataset.csv | roi_per_million_spend | 0 | 1.0000 | 78 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_18 | 0 | 1.0000 | 78 | Review before production modeling |
| data/user_behavior_chain.csv | roi_per_million_spend | 0 | 1.0000 | 78 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_07 | 0 | 1.0000 | 73 | Review before production modeling |
| data/attention_timeseries.csv | sentiment_score | 0 | 1.0000 | 72 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_14 | 0 | 1.0000 | 72 | Review before production modeling |
| data/roi_predictions.csv | roi_lift_vs_spend | 0 | 1.0000 | 67 | Review before production modeling |
| data/fan_score_outputs.csv | fan_score_module | 0 | 1.0000 | 61 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_16 | 0 | 1.0000 | 58 | Review before production modeling |
| data/text_embeddings_reduced.csv | text_svd_22 | 0 | 1.0000 | 57 | Review before production modeling |
...
| data/text_embeddings_reduced.csv | text_svd_23 | 0 | 1.0000 | 48 | Review before production modeling |
...
| data/panel_dataset.csv | core_player_rating | 0 | 1.0000 | 30 | Review before production modeling |
| data/user_behavior_chain.csv | core_player_rating | 0 | 1.0000 | 30 | Review before production modeling |
| data/historical_matches.csv | media_reposts_k | 0 | 1.0000 | 24 | Monitor source quality |
| data/modeling_dataset.csv | media_reposts_k | 0 | 1.0000 | 24 | Review before production modeling |
| data/roi_predictions.csv | media_reposts_k | 0 | 1.0000 | 24 | Review before production modeling |
| data/social_media.csv | media_reposts_k | 0 | 1.0000 | 24 | Review before production modeling |
| data/modeling_dataset.csv | b_elo | 0 | 1.0000 | 22 | Review before production modeling |
| data/modeling_dataset.csv | b_squad_market_value_m | 0 | 1.0000 | 22 | Review before production modeling |
| data/modeling_dataset.csv | b_recent_goal_diff | 0 | 1.0000 | 22 | Review before production modeling |
| data/modeling_dataset.csv | b_social_followers_m | 0 | 1.0000 | 22 | Review before production modeling |
| data/roi_predictions.csv | b_elo | 0 | 1.0000 | 22 | Review before production modeling |
| data/roi_predictions.csv | b_squad_market_value_m | 0 | 1.0000 | 22 | Review before production modeling |
| data/roi_predictions.csv | b_recent_goal_diff | 0 | 1.0000 | 22 | Review before production modeling |
| data/roi_predictions.csv | b_social_followers_m | 0 | 1.0000 | 22 | Review before production modeling |
| data/social_media.csv | hashtag_mentions_k | 0 | 1.0000 | 22 | Review before production modeling |
...
| real_text_articles.csv | 4321 | 10 | 136 | 0 | text_id, source, title, url, domain, language, sourcecountry, published_at |
| text_embeddings_reduced.csv | 4321 | 31 | 0 | 0 | text_id, source, domain, narrative_topic, sentiment_score, text_svd_01, text_svd_02, text_svd_03 |
| attention_timeseries.csv | 10604 | 7 | 0 | 0 | match_id, day_offset, team_a, team_b, attention_index, engagement_rate, sentiment_score |
| media_text_corpus.csv | 4321 | 15 | 8778 | 0 | text_id, source, sample_headline, source_url, domain, language, sourcecountry, published_at |
