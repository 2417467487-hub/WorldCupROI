...
| sponsor_roi | Ridge regression | trained | r2 | 0.859 | mae | 0.1213 | dependency-free baseline |
| match_outcome | Logistic Regression | trained | accuracy | 0.5425 | package | sklearn | optional benchmark |
| match_outcome | Random Forest | trained | accuracy | 0.5094 | package | sklearn | optional benchmark |
| match_outcome | MLP | trained | accuracy | 0.5377 | package | sklearn | optional benchmark |
| sponsor_roi | Random Forest | trained | r2 | 0.8471 | mae | 0.126 | optional benchmark |
| sponsor_roi | MLP | trained | r2 | -2.7334 | mae | 0.5487 | optional benchmark |
