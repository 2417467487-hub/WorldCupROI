...
| sponsor_roi | Ridge regression | trained | r2 | 0.8654 | mae | 0.1181 | dependency-free baseline |
...
| sponsor_roi | Random Forest | trained | r2 | 0.8401 | mae | 0.1269 | optional benchmark |
| sponsor_roi | MLP | trained | r2 | -2.3336 | mae | 0.5343 | optional benchmark |
